    ...
    <>
      <Box>
        <ResponsiveContainer width="100%" aspect={3}>
          <LineChart data={data}>
            {/*   <CartesianGrid /> */}
            {props.domain && <YAxis domain={props.domain}></YAxis>}

            {props.domain === undefined && (<YAxis type="number" domain={[dataMin => {return (0.9 * dataMin)}, dataMax=>{ return (1.1 *dataMax)}]} ></YAxis>)}
